...
## Componentes de un kit de goteo: qué lleva la caja y qué no

Antes de comprar, conviene saber qué piezas vas a tener entre manos. La mayoría de kits traen lo básico, pero hay extras que o bien no vienen, o bien merece la pena añadir:

- **Tubería principal de PE 16 mm**: el "médula espinal" del sistema. Lleva el agua desde el grifo o el depósito hasta las macetas. Negra, flexible, duradera. Se corta fácil con tijeras.
- **Microtubo de 4-6 mm**: las ramitas que salen de la tubería principal y terminan en cada maceta. Suelen ser de 30-50 cm, suficientes para mover la maceta sin desmontar nada.
- **Goteros**: la pieza clave. Hay de cuatro tipos:
  - *Integrados* en la tubería cada 30 cm (tubería gotero).
  - *Pinchados* (se clavan en la tubería principal con un punzón).
  - *Regulables* (0-50 L/h, se abren o cierran a mano).
  - *Autocompensantes* (mantienen el caudal constante aunque haya pendiente o longitud). Son los mejores, aunque más caros.
- **Conectores**: codos (para girar), tes (para bifurcar), enlaces (para unir dos tramos). Imprescindibles para adaptar el recorrido a tu terraza.
- **Filtro de malla**: esencial si tu agua tiene cal o sedimentos. Sin filtro, los goteros se obstruyen en meses.
- **Regulador de presión**: baja la presión del grifo doméstico (3-4 bar) a 1,5-2 bar, que es lo que los goteros necesitan para funcionar bien. Algunos kits ya lo traen integrado.
- **Programador de riego**: a pilas, con Bluetooth o eléctrico. Te permite programar horas y duración. Los más vendidos son a pilas, muy fiables, sin instalación eléctrica. Si quieres entender mejor los matices técnicos, la guía de [Leroy Merlin](https://www.leroymerlin.es/ideas-y-consejos/paso-a-paso/como-instalar-riego-por-goteo-en-el-huerto.html) y la de [Planeta Huerto](https://www.planetahuerto.es/blogs/guias/como-elegir-el-sistema-de-riego-por-goteo) son lecturas obligatorias.

Si tu kit no trae filtro o regulador (suele pasar con los básicos), cómpralos aparte. Son 8-12€ extra que te ahorrarán disgustos.

![Componentes de un kit de riego por goteo: tubería, goteros, conectores y filtro](/images/componentes-kit-riego-goteo.webp)

---

## Tipos de kits: cuatro categorías para no equivocarte

Antes de mirar productos concretos, lo importante es saber qué tipo de kit se adapta a tu situación. No es lo mismo un balcón con grifo en la pared que una terraza donde tienes que cargar cubos.

### Kit con grifo (el clásico)
...
La opción clásica "sin grifo y sin electricidad". Necesitas un depósito elevado a 1-2 metros de altura (o una bomba a pilas). El agua cae por su propio peso. Claber tiene un sistema mítico en este formato. Funciona bien, pero el caudal depende de la altura del depósito.

### Microtubo vs tubería con gotero integrado
...
Antes de decidirte, ten en cuenta estos seis puntos. Te ahorra devolver el kit a la semana.

**1. Caudal del gotero**: 2 L/h es el estándar y funciona bien para la mayoría de plantas en maceta. Si cultivas plantas grandes (calabacines, tomates en maceta de 40 cm) sube a 4-8 L/h. Los regulables 0-50 L/h son versátiles pero más caros.

**2. Autocompensantes o no**: si tu terraza tiene pendiente o las macetas están muy separadas, los goteros autocompensantes mantienen el caudal constante. Si todo está en plano, ahorra dinero con los normales.

**3. Compatibilidad con tu grifo**: si no tienes grifo en la terraza, descarta directamente los kits "con grifo" y ve a solar (TRJZWA) o por gravedad (Claber). No intentes adaptar un kit con grifo a un depósito, no funciona bien.

**4. Número de macetas**: kits de 10-15 macetas son lo habitual. Calcula macetas reales que tienes, no las que "tendrás algún día". Y comprueba que sea ampliable con piezas sueltas.

**5. Filtro**: imprescindible si tu agua tiene cal. El filtro cuesta 5-10 € y alarga la vida del sistema. Si tu kit no lo trae, cómpralo aparte el primer día.

**6. Caudal de las plantas que cultivas**: si cultivas plantas que beben mucho como los [pimientos en maceta](/guias-cultivo/como-cultivar-pimientos-en-maceta/), asegúrate de que el caudal del gotero cubra sus necesidades. Un gotero de 2 L/h puede quedarse corto en pleno agosto para plantas en macetas pequeñas.

Si cultivas especies más resistentes o de poco consumo, casi cualquier kit te vale. Y si cultivas [hierbas aromáticas en maceta](/guias-cultivo/como-cultivar-hierbas-aromaticas-en-casa/), el goteo es ideal porque mantienen una humedad uniforme sin encharcar.
...
3. **Corta con tijeras afiladas, no con sierra**: las tuberías de PE se cortan limpio con tijeras. Si usas sierra, dejas rebabas que luego obstruyen goteros.
4. **Pincha los goteros donde toca cada maceta**: usa el punzón que traen los kits (o un clavo fino) para hacer el agujero en la tubería principal. Luego clava el gotero con firmeza. Conecta el microtubo y llévalo a la maceta.
5. **Conecta al grifo + filtro + regulador**: el orden importa. Grifo -> filtro -> regulador de presión -> tubería principal. Sin regulador, los goteros pueden reventar o gotear de más.
6. **Prueba 30 minutos y observa**: abre el agua, espera media hora, y comprueba que todas las macetas reciben agua por igual. Ajusta goteros flojos o tapones si hay fugas.

Si quieres profundizar en la frecuencia de riego, en nuestra [guía de cómo regar el huerto urbano en verano](/cuidado-mantenimiento/como-regar-huerto-urbano-verano/) te explicamos cómo calcular los minutos exactos. Y si planificas el huerto, mira [qué plantar en julio](/huerto-urbano/que-plantar-julio-huerto-urbano/) para diseñar el recorrido.

![Persona instalando un sistema de riego por goteo en macetas de balcón](/images/instalacion-riego-goteo-balcon.webp)
...
- **Purga al inicio de temporada**: abre el grifo al máximo 2-3 minutos para expulsar sedimentos del invierno.
